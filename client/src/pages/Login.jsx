...
const Login = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    setLoading(true)
   try {
    const response = await axios.post('http://localhost:3333/user/login',formData,{withCredentials:true})
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4  relative overflow-hidden text-white">
      ...
      <div className="bg-gray-700/90 p-8 rounded-lg shadow-md w-full max-w-md relative z-10 backdrop-blur-sm text-white">
        <h1 className='text-3xl font-bold text-blue-500 mb-4 text-center'>Blog-Z</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 text-white">
          <div>
            ...
            <input
              ...
              name="email"
              required
              className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-600 text-white placeholder-gray-300"
        ...
        <div className="mt-8">
          ...
          <div className="flex justify-center space-x-4">
            <button
              ...
              className="p-2 rounded-full bg-white/90 hover:bg-white transition duration-200 shadow-lg"
            >
              {/* Google SVG Icon */}
