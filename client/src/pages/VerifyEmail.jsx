...
const VerifyEmail = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("OTP to send:", fullOtp,email);  // Add logging for debugging

      const response = await axios.post(
        'http://localhost:3333/user/resetpassword',
        { email:email, otp: fullOtp }, // Send OTP as string, not number
